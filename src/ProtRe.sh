...
python sesica_arc.py -base_dir ../data/ProtRe -category Protein -bmk_fasta ../data/ProtRe/bmk_fasta.fasta -bmk_label ../data/ProtRe/pos_label.txt ../data/ProtRe/neg_label.txt -arc dssm -word_size 3 -metric roc@1 -dssm_epoch 10
