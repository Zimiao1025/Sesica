...
# python sesica_clf.py -base_dir ../data/iCircDA -data_type hetero -bmk_vec_a ../data/iCircDA/bmk_circRNA.txt -bmk_vec_b ../data/iCircDA/bmk_disease.txt -bmk_label ../data/iCircDA/benchmark_pos.txt ../data/iCircDA/benchmark_neg.txt -clf svm rf ert knn mnb gbdt goss dart mlp -metric auc -gs_mode 2 -ind test -ind_vec_a ../data/iCircDA/bmk_circRNA.txt -ind_vec_b ../data/iCircDA/bmk_disease.txt -ind_label ../data/iCircDA/ind_pos.txt ../data/iCircDA/ind_neg.txt
