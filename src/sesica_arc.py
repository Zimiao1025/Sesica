...
if __name__ == '__main__':
    ...
    parse.add_argument('-mv_lstm_neg', type=int, default=4, help="Number of negative samples for ranking of mv_lstm model.")
    ...
    parse.add_argument('-mv_lstm_layers', type=int, default=2, help="Number of mlp layers for mv_lstm model.")
    parse.add_argument('-mv_lstm_units', type=int, default=20, help="Number of mlp units for mv_lstm model.")
    parse.add_argument('-mv_lstm_hs', type=int, default=32, help="Hidden size of mv_lstm model.")
    parse.add_argument('-mv_lstm_top_k', type=int, default=20, help="Size of top-k pooling layer of mv_lstm model.")
    parse.add_argument('-mv_lstm_emb', type=int, default=128, help="Embedding output dimension of mv_lstm model.")
    # parameters for drmm
    ...
    parse.add_argument('-drmmtks_emb', type=int, default=128, help="Embedding output dimension of drmm model.")
    parse.add_argument('-drmmtks_layers', type=int, default=1, help="Number of mlp layers for drmmtks model.")
    parse.add_argument('-drmmtks_units', type=int, default=32, help="Number of mlp units for drmmtks model.")
    parse.add_argument('-drmmtks_top_k', type=int, default=10, help="Size of top-k pooling layer of drmmtks model.")
    ...
    parse.add_argument('-match_lstm_hs', type=int, default=32, help="Hidden size of match_lstm model.")
    parse.add_argument('-match_lstm_emb', type=int, default=128, help="Embedding output dimension of match_lstm model.")
    # parameters for duet
    parse.add_argument('-duet_ngram', type=int, default=3, help="The N of n-gram model for duet model.")
    ...
    parse.add_argument('-duet_layers', type=int, default=1, help="Number of mlp layers for duet model.")
    parse.add_argument('-duet_units', type=int, default=32, help="Number of mlp units for duet model.")
    # parameters for knrm
    ...
    parse.add_argument('-knrm_emb', type=int, default=128, help="Embedding output dimension of knrm model.")
