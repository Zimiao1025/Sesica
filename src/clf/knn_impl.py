...
def knn_train(train_x, train_y, val_x, val_y, val_g, model_path, params):
    # get n_neighbors
    n_range = params['knn_n']
    ...
    for i in range(top_n):
        ...
        clf = KNeighborsClassifier(n_neighbors=hp[0])
        clf.fit(train_x, train_y)
